...
import org.apache.ibatis.reflection.testextend.MainClass;
import org.apache.ibatis.reflection.testextend.TestA;
...
public class TypeParameterResolverTest {
    ...
    @Test
    public void testReturn_Lv0Select() throws Exception {
        Class<?> clazz = Level0Mapper.class;
    ...
    public void testA() throws NoSuchFieldException {
        Field fieldMap = TestA.class.getDeclaredField("map");
        System.out.println(fieldMap.getGenericType());
        System.out.println(fieldMap.getGenericType() instanceof ParameterizedType);

        //Type type = TypeParameterResolver.resolveFieldType(fieldMap, ParameterizedTypeImpl.make(TestASon.class, new Type[]{Long.class}, MainClass.class));
        Type type = org.apache.ibatis.reflection.testextend.TypeParameterResolver.resolveFieldType(fieldMap, MainClass.class.getDeclaredField("testA").getGenericType());
    ...
    @Test
    public void testSon() throws NoSuchFieldException {
        Field fieldMap = TestA.class.getDeclaredField("map");
        System.out.println(fieldMap.getGenericType());
        System.out.println(fieldMap.getGenericType() instanceof ParameterizedType);

        //Type type = TypeParameterResolver.resolveFieldType(fieldMap, ParameterizedTypeImpl.make(TestASon.class, new Type[]{Long.class}, MainClass.class));
        Type type = org.apache.ibatis.reflection.testextend.TypeParameterResolver.resolveFieldType(fieldMap, MainClass.class.getDeclaredField("testASon").getGenericType());
        System.out.println(type.getClass());
    ...
    @Test
    public void testGrandSon() throws NoSuchFieldException {
        Field fieldMap = TestA.class.getDeclaredField("map");
        System.out.println(fieldMap.getGenericType());
        System.out.println(fieldMap.getGenericType() instanceof ParameterizedType);

        //Type type = TypeParameterResolver.resolveFieldType(fieldMap, ParameterizedTypeImpl.make(TestASon.class, new Type[]{Long.class}, MainClass.class));
        Type type = org.apache.ibatis.reflection.testextend.TypeParameterResolver.resolveFieldType(fieldMap, MainClass.class.getDeclaredField("testAGrandSon").getGenericType());
        System.out.println(type.getClass());
