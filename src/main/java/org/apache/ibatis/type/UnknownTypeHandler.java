...
public class UnknownTypeHandler extends BaseTypeHandler<Object> {
    ...
    /**
     * setNonNullParameter调用，当parameter为Object类型时，会通过getClass尝试获取真实的handler，如果找不到或者真的是Object，那么使用OBJECT_TYPE_HANDLER
     *
     * @param parameter
     * @param jdbcType
     * @return
    ...
    /**
     * 将column转成columnIndex查找，找不到就用OBJECT_TYPE_HANDLER
     *
     * @param rs
     * @param column
     * @return
    ...
    /**
     * 根据columnIndex解析出的JavaType和JdbcType查找handler
     *
     * @param rsmd
     * @param columnIndex
     * @return
    ...
    /**
     * 根据columnIndex对应的JdbcType解析出JavaType
     *
     * @param rsmd
     * @param columnIndex
     * @return
